...
URL_INCLUSION_KEYWORDS = [
    ...
    "industryslice", "usemailora", "pymnts", "communications.pymnts", "economy","govloanoptions","firstcry","quicklly",
    "labor-economy", "spending", "martech", "usnews", "latimes", "marketscreener","inshot","outlookbusiness",
    "summit", "russell", "ferrari", "letstalk", "bummer", "indianexpress","imbaglobal","updates.quicklly","famyo",
